...
/** listGoodsVOByPageFast POST /api/goods/list/page/vo/fast */
export async function listGoodsVoByPageFastUsingPost(
  body: API.GoodsQueryRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponsePageGoodsVO_>('/api/goods/list/page/vo/fast', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
